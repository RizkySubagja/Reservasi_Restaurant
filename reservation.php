      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Order <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-6 order-md-last ftco-animate makereservation p-4 p-md-5 pt-5">
          	<div class="py-md-5">
	            ...
	            <form action=" " method="post">
                    ...
                    <label><b>Food / Drink</b></label>
	                	<div class="form-group row">
                    <div class="col-md-6 mb-4 mb-lg-0">
	                	<select class="form-control" name="pesanan">
            			<?php
                			$data = mysqli_query($koneksi1 , "select nama from menu");
                  ...
                  <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Large or Small ?" name="serving">
                    </div>
	                	</div>
                    <label><b>Food / Drink</b></label>
                    <div class="form-group row">
                    <div class="col-md-6 mb-4 mb-lg-0">
                    <select class="form-control" name="pesanan_1">
                  <?php
                      $data = mysqli_query($koneksi1 , "select nama from menu");
                      while ($d = mysqli_fetch_array($data)) { ?>
                      <option><?= $d['nama']; ?></option>        
                  ...
                  <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Large or Small ?" name="serving_1">
                    </div>
                    </div>
	                  <div class="form-group">
	                    <label>Time</label>
                    ...
                    <div class="form-group">
              		...
              		<button class="btn btn-primary py-3 px-5" name="submit">Send Order</button> 
	            </form>
	          </div>
          </div>
        </div>
