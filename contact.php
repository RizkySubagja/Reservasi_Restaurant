...
require 'admin/insertpesan.php';
?>
<?php

if (isset($_POST["submit"])) {
    
    if (contact_us($_POST) > 0) {
        echo "<script>
      ...
      <div class="container">
        <div class="row d-flex contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span>Address:</span> Jln H Dasuki no 4 , Padalarang, Bandung Barat, Indonesia 40553</p>
            </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span>Phone:</span> <a href="tel://089651531567">+62 8965 1531 567</a></p>
            </div>
          </div>
          <div class="col-md-6 d-flex">
          	<div class="dbox">
	            <p><span>Email:</span> <a href="mailto:rizkyhasky81@gmail.com">rizkyhasky81@gmail.com</a></p>
            </div>
          </div>
        </div>
      </div>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
			<div class="container">
              ...
              <button class="btn btn-primary py-3 px-5" name="submit">Send Message</button> 
            </form>
					</div>
				</div>
			</div>
