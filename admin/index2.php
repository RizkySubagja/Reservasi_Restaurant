...
<html lang="en">
  ...
  $no = 1;
  $data = mysqli_query($koneksi1,"select*from reservasi");
  ...
  <tr>
    ...
    <td><?php echo $d["serving"]; ?></td>
    <td><?php echo $d["pesanan_1"]; ?></td>
    <td><?php echo $d["serving_1"]; ?></td>
    <td><?php echo $d["waktu"]; ?></td>
    <td><?php echo $d["jumlah_orang"]; ?></td>
    <td><?php echo $d["pesan"]; ?></td>
    <?php echo "<br>"; ?>
    <td><a href="Delete2.php?nama=<?php echo $d['nama']; ?>"><button class="btn btn-danger" onclick="return confirm('Yakin anda ingin menghapus data ini ?')"> Hapus</button></a></td> 
  </tr>
<?php
}
?>
