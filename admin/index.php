...
<html lang="en">
  ...
  $no = 1;
  $data = mysqli_query($koneksi1,"select*from contact_us");
  ...
  <tr>
    ...
    <?php echo "<br>"; ?>
    <td><a href="Delete.php?email=<?php echo $d['email']; ?>"><button class="btn btn-danger" onclick="return confirm('Yakin anda ingin menghapus data ini ?')"><i class="fa fa-trash"> Hapus</i></button></a></td> 
  </tr>
<?php
}
?>
