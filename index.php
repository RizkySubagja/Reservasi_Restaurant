    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
          ...
          <div class="col-md-6 ftco-animate makereservation p-4 p-md-5 pt-5 pt-md-0">
            ...
            <form action="" method="post">
                  ...
                  <div class="form-group">
                    <label>Phone</label>
                    <input type="phone" class="form-control" placeholder="Phone" name="telepon">
                  </div>
                  <div class="form-group">
                    <label>Date</label>
                  ...
                  <div class="form-group">
                    <label>Time</label>
                    <input type="time" class="form-control" placeholder="Time" name="waktu">
                  </div>
                  <div class="form-group">
                    <label>Person</label>
                    <input type="phone" class="form-control" name="jumlah_orang">
                  </div>
              		<button class="btn btn-primary py-3 px-5" name="submit">Send Reservation</button> 
            </form>
          </div>
        </div>
			</div>
